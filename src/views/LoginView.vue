  ...
  <section class="auth-view">
    ...
    <div class="content">
      <div class="heading-wrap">
        <h1 class="title">Log<span class="accent">In</span></h1>
        <p class="subtitle">Jump back into QuizBlitz</p>
      </div>
      ...
      <RouterLink to="/register" class="swap-link"
        >Need an account? Register</RouterLink
      >
    </div>
  </section>
</template>
